    ...
    >
      ...
      <div class="bg-stone-100 flex justify-center items-center overflow-hidden dark:bg-slate-900 rounded-xl">
        <img
          ...
          class="rounded-xl h-[325px] w-[430px] xl:h-[265px] xl:w-[390px] lg:h-[235px] md:h-[265px] 2xs:h-[260px] 2xs:max-w-[315px] xs:h-[250px] xs:max-w-[315px]"
          alt=""
        />
      </div>
      <!--Profile Info-->
      <div class="pt-4 md:pt-3 2xs:pt-2 dark:text-slate-200">
        <h2 class="py-2 xl:text-3xl md:text-2xl 2xs:text-2xl font-semibold">Abdul Baset Bappy👋</h2>
        <p class="text-md lg:text-lg md:text-sm 2xs:text-base">
      ...
      <div class="xl:py-4 md:py-2 2xs:py-2">
        <button
          class="xl:m-1 md:m-1 2xs:text-sm xl:text-xl lg:py-3 2xs:m-1 bg-slate-700 2xs:px-3 2xs:py-2 text-slate-50 py-3 xl:ml-0 2xs:ml-0 px-4 rounded-md"
        >
          <Icon
        ...
        <button class="xl:m-1 xl:mr-0 md:m-1 2xs:text-sm 2xs:mr-0 2xs:m-1 2xs:px-3 2xs:py-2 xl:text-xl lg:py-3 bg-slate-700 text-slate-50 py-3 px-4 rounded-md">
          <Icon
