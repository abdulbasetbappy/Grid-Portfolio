    ...
    >
      ...
      >
        ...
        <div class="flex justify-between items-center">
          <h2
            class="2xl:text-4xl xl:text-3xl 2xs:text-2xl lg:text-xl pb-2 font-san font-semibold"
          >
            Recent Projects
          </h2>
          <NuxtLink
        ...
        <!--Projects-->
        <div
          class="mt-6 lg:mt-3 md:mt-4 flex flex-col justify-center items-center gap-6 lg:gap-3 2xl:gap-6"
        >
          <!--Project 01-->
          <div
      ...
      >
        <div class="">
          ...
          <div class="flex items-center justify-between mt-1 xl:mt-8 2xl:mt-16">
            <p class="uppercase 2xs:text-sm xl:text-xl xl:font-semibold 2xl:text-2xl">Credentials</p>
            <NuxtLink to="/About" class="border-b-2 2xs:text-sm 2xl:text-xl">
              More About Me
              <Icon name="ph:arrow-elbow-right-light" class="h-6 w-6" />
            </NuxtLink>
          </div>
      ...
      <!--Main Content-->
        <p
          class="font-bold xl:py-2 md:py-2 lg:py-2 lg:leading-tight xl:text-[50px] 2xl:text-[60px] 2xs:text-[30px] xs:text-[40px]"
        >
          Let's👋 <br />
          Work Together
        </p>
        ...
        <div class="flex justify-end items-center">
          <NuxtLink to="/contact" class="border-b-2 2xs:text-base lg:text-sm xl:text-base 2xl:text-xl">
            Let's Talk
            <Icon name="ph:arrow-elbow-right-light" class="h-6 w-6" />
          </NuxtLink>
        </div>
