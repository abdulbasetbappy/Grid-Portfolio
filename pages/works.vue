<template>
  ...
  >
    ...
    >
      ...
      <!--Project Archive-->
      <div class="grid grid-cols-1 p-8 pt-0 mt-4">
        <!--single-Project-->
        <div class="md:col-span-1 p-4">
          <!--single-Blog-Image-->
          <div class="relative">
            <img class="rounded-xl w-full h-[355px]" src="~/assets/Porject01.png" alt="" />
            <p class="absolute bottom-2 left-0 dark:bg-neutral-700 rounded-r-md px-5">Web Development</p>
          <!--single-Blog-Details-->
          <div class="absolute top-0 cursor-pointer gap-4 left-0 flex justify-center items-center opacity-0 hover:opacity-100 hover:transition-all hover:duration-700 hover:ease-in-out rounded-lg hover:bg-neutral-900 hover:bg-opacity-30 w-full h-full">
            <NuxtLink to="" class="bg-neutral-700 px-3 py-2 rounded-md" ><Icon name="mdi:eye-outline"/> Live Demo  </NuxtLink>
            <NuxtLink to="" class="bg-neutral-700 px-3 py-2 rounded-md" > <Icon name="tdesign:terminal"/> See Code</NuxtLink>
          </div>
          </div>
      ...
      <div class=" flex justify-center items-center gap-4 my-4">
        <button class="dark:bg-neutral-600 px-5 py-2 text-lg rounded-xl"><Icon name="material-symbols:arrow-left-alt-rounded" /></button>
        <button class="dark:bg-neutral-600 px-5 py-2 text-lg rounded-xl">
